...
?>
  <div class="main-login">
    ...
    <div class="right-login">
      ...
      <button class="btn-login" type=submit name=botao href="consulta.php">  <a class="nav-link active" aria-current="page" href="consulta.php">Página de consultas</a></button>
    </div>
  </div>
</div>
</body>
