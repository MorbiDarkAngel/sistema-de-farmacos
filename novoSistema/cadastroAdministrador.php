...
if (@$_REQUEST['botao'] == "Gravar") 
{
    if (!$_REQUEST['id_usuario'])
    {
        ...
        else echo "<script>alert('Cadastro não realizado');top.location.href=cadastroAdministrador.php';</script>"; 
...
?>
    ...
    <div class="social-media">
      ...
      <form action="cadastroAdministrador.php" method="post" name="cadastroAdministrador"> 
        ...
        <label for="login">
         ...
         <tr>
            <td><input type="hidden" name="tipo" value="ADMIN">
         </tr>
    ...
    <section class="images">
      <img src="assets/lyre.png" alt="lyre">
